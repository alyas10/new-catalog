...
\
● В классе \[БАЗОВЫЙ\_КЛАСС\] должны быть закрытое (private) поле \[идентификатор\] строкового типа, публичное (public) поле \[параметр\] целочисленного типа и методы, устанавливающие и возвращающие данные значения («геттеры» «сеттеры»);\
